    ...
    <footer style={{
      ...
      <div style={{display: 'flex', flexDirection: 'column', gap: 6}}>
        <div style={{display: 'flex', alignItems: 'center', gap: 8}}>
          ...
          <span style={{
            ...
            height: 8,
            borderRadius: '50%',
            background: obsStatuses.media && obsStatuses.titrage ? '#3c3' : 'var(--text-light)',
            border: '1px solid var(--border)'
        ...
        <div style={{display: 'flex', alignItems: 'center', gap: 8}}>
          ...
          <span style={{
            ...
            height: 8,
            borderRadius: '50%',
            background: obsStatuses.media ? '#3c3' : 'var(--text-light)',
            border: '1px solid var(--border)'
          }} title="Statut de diffusion" />
        </div>
        ...
        <div style={{display: 'flex', alignItems: 'center', gap: 8}}>
          ...
          <span style={{
            ...
            height: 8,
            borderRadius: '50%',
            background: obsStatuses.titrage ? '#3c3' : 'var(--text-light)',
            border: '1px solid var(--border)'
          }} title="Statut de diffusion" />
        </div>
      </div>
      ...
      <div style={{flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 16, minWidth: 0}}>
        <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', minWidth: 0}}>
          ...
          />
          <div style={{color: 'var(--text-light)', fontSize: 13, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: 200, textAlign: 'center'}}>
            {currentInfo.programTitle || 'Aucun programme'}
          </div>
        </div>
        {currentInfo.topicTitle && (
          <div style={{fontSize: 15, color: 'var(--text)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: 400, textAlign: 'center'}}>
            {currentInfo.topicTitle}
          </div>
        )}
      </div>
      ...
      <div style={{display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 8}}>
        ...
        <div style={{display: 'flex', alignItems: 'center', gap: 12, fontSize: 13, color: 'var(--text-light)', minWidth: 120, justifyContent: 'flex-end'}}>
          ...
          <span style={{
            ...
            height: 12, 
            borderRadius: '50%', 
            background: wsConnected ? '#3c3' : '#f44',
            border: '1px solid var(--border)',
